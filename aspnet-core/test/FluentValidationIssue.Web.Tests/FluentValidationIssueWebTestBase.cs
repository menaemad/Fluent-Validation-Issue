...
{
    public abstract class FluentValidationIssueWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static FluentValidationIssueWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(FluentValidationIssueWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<FluentValidationIssueDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<FluentValidationIssueDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<FluentValidationIssueDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<FluentValidationIssueDbContext, Task<T>> func)
        {
            T result;
